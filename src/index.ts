...
import type { StarWarsResult, AnalyzeRequest } from "./shared/types.js";
 ...
 */
const elements = {
    aurebeshDisplay   : document.querySelectorAll<HTMLSpanElement>(".aurebesh"),
    normalDisplay     : document.querySelectorAll<HTMLSpanElement>(".normal"),
    addFileButton     : document.querySelector<HTMLButtonElement>("#add_file_button"),
    hiddenFileInput   : document.querySelector<HTMLInputElement>("#hidden_file_input"),
    marqueeTrack      : document.querySelector<HTMLElement>(".marquee_track"),
    resultsContainer  : document.querySelector<HTMLElement>(".resume_grade_container"),
};
 ...
 */
function createResultCard(result: StarWarsResult): HTMLElement {
 ...
 */
function updateMarqueeDisplay(fileName: string): void {
...
function init(): void {
    ...
    elements.hiddenFileInput?.addEventListener("change", (event: Event) => {
